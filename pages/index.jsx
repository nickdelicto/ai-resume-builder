...
const HomePage = () => {
  ...
  useEffect(() => {
    ...
    console.log('📊 DEBUG - HOME - localStorage keys:', Object.keys(localStorage));
    console.log('📊 DEBUG - HOME - resumeId in localStorage:', localStorage.getItem('current_resume_id'));
    console.log('📊 DEBUG - HOME - starting_new_resume flag:', localStorage.getItem('starting_new_resume'));
    ...
    if (localStorage.getItem('starting_new_resume') === 'true') {
      ...
      // This is a safety check in case it wasn't properly cleared before
      if (localStorage.getItem('current_resume_id')) {
        console.log('📊 DEBUG - HOME - resumeId still exists, clearing it again');
      ...
      console.log('📊 DEBUG - HOME - After clearing flag, localStorage keys:', Object.keys(localStorage));
      console.log('📊 DEBUG - HOME - After clearing flag, resumeId in localStorage:', localStorage.getItem('current_resume_id'));
      
      // If resumeId is still somehow there, try one more time with a different approach
      if (localStorage.getItem('current_resume_id')) {
        console.error('📊 DEBUG - HOME - resumeId STILL exists after clearing, trying alternative method');
        try {
          window.localStorage.removeItem('current_resume_id');
          console.log('📊 DEBUG - HOME - After second clearing attempt, resumeId:', localStorage.getItem('current_resume_id'));
        } catch (e) {
          console.error('📊 DEBUG - HOME - Failed to clear resumeId with alternative method:', e);
        }
      }
    }
  }, []);
