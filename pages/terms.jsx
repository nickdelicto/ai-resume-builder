  ...
  return (
    <>
      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <p className="mb-4">You may terminate your account at any time by following the instructions on the Services or contacting us through our contact page.</p>
        ...
        <p className="mb-4">If you have any questions about these Terms, please contact us through our contact page.</p>
