...
import { fetchStateExperienceLevelSignOnBonusJobs } from '../../../../../../lib/services/jobPageData';
          ...
          {jobs.length > 0 ? (
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 text-center border border-gray-200">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                No {experienceLevel} Sign-On Bonus Jobs in {stateFullName}
              </h2>
              <p className="text-gray-600 mb-6">
                New {experienceLevel} positions with sign-on bonuses are added regularly. Check back soon or browse other options.
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                ...
                <Link
                  href={`/jobs/nursing/experience/${levelSlug}/sign-on-bonus`}
                ...
                >
                  All {experienceLevel} Sign-On Bonus Jobs
                </Link>
              </div>
            </div>
          )}
