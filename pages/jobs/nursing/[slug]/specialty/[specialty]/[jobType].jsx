...
import { fetchStateSpecialtyJobTypeJobs } from '../../../../../../lib/services/jobPageData';
          ...
          {jobs.length > 0 ? (
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 text-center border border-gray-200">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                No {jobType} {specialty} RN Jobs in {stateFullName}
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link
                  href={`/jobs/nursing/${stateCode.toLowerCase()}/job-type/${jobTypeSlug}`}
                ...
                >
                  View All {jobType} Jobs in {stateFullName}
                </Link>
              </div>
            </div>
          )}
