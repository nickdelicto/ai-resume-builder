          ...
          {jobs.length > 0 ? (
            ...
            <div className="bg-white rounded-xl shadow-sm p-8 text-center border border-gray-200">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-2">
                No {experienceLevel} {specialty} Sign-On Bonus Jobs in {stateFullName}
              </h2>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                ...
                >
                  All {specialty} Sign-On Bonus Jobs in {stateFullName}
                </Link>
                <Link
                  href={`/jobs/nursing/${stateCode.toLowerCase()}/experience/${levelSlug}/sign-on-bonus`}
                ...
                >
                  All {experienceLevel} Sign-On Bonus Jobs in {stateFullName}
                </Link>
              </div>
            </div>
          )}
