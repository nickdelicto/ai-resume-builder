...
function generateSalaryPageMetaTags(location, locationType, salaryStats) {
  ...
  if (avgHourly && avgAnnual) {
    title = `Average RN Salary in ${location} - ${formatSalary(avgHourly, 'hourly')} & ${formatSalary(avgAnnual, 'annual')}`;
  } else if (avgHourly) {
    title = `Average RN Salary in ${location} - ${formatSalary(avgHourly, 'hourly')}`;
  } else if (avgAnnual) {
    title = `Average RN Salary in ${location} - ${formatSalary(avgAnnual, 'annual')}`;
  } else {
    title = `Average RN Salary in ${location}`;
  }
