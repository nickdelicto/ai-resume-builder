...
function generateListingPageMetaTags(filters, pagination) {
  ...
  const title = locationText 
    ...
    : 'RN Nursing Jobs - Registered Nurse Positions | IntelliResume';
  ...
  const description = locationText
    ...
    : `Browse ${jobCount > 0 ? jobCount : 'thousands of'} Registered Nurse (RN) job openings across top healthcare employers. Search by location, specialty, and job type.`;
