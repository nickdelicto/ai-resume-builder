...
class DbResumeService extends ResumeService {
  ...
  isAvailable() {
    ...
    console.log('📊 [DbResumeService] isAvailable check:', {
      ...
      location: inBrowser ? window.location.href : 'server-side',
    ...
    if (typeof fetch !== 'function') {
      console.log('📊 [DbResumeService] Not available: Fetch API not available');
      return false;
    }
  ...
  async initialize(options = {}) {
    console.log('📊 [DbResumeService] initialize called with options:', {
      providedIsAuthenticated: options.isAuthenticated,
      typeOfIsAuthenticated: typeof options.isAuthenticated,
      previousValue: this.isAuthenticated,
      timestamp: new Date().toISOString(),
    ...
    console.log('📊 [DbResumeService] isAuthenticated set to:', this.isAuthenticated);
    
    if (!this.isAuthenticated) {
      console.log('📊 [DbResumeService] initialization failed - user not authenticated');
      return {
        success: false,
    ...
    console.log('📊 [DbResumeService] initialization successful');
    return {
      success: true
    };
  }
  ...
  async listResumes() {
    ...
    try {
      ...
      const isSuccessful = result.success !== undefined ? result.success : true;
