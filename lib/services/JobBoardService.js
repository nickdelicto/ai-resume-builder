      ...
      if (existingJob) {
        ...
        const updatedJob = await prisma.nursingJob.update({
          ...
          data: {
            ...
            // Only update rawDescription if provided (don't overwrite with null on updates that skip detail fetch)
            ...(jobData.rawDescription ? { rawDescription: jobData.rawDescription } : {}),
