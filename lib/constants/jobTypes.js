...
/**
 * Normalize job type to canonical format for database storage
 * Examples: 'Full Time' -> 'full-time', 'Per Diem' -> 'per-diem', 'PRN' -> 'per-diem'
 * Returns null if not a recognized job type
 */
