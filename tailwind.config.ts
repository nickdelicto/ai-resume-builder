  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'dialog-overlay': 'hsl(var(--dialog-overlay))',
        'dialog-background': 'hsl(var(--dialog-background))',
        'dialog-foreground': 'hsl(var(--dialog-foreground))',
        'dialog-border': 'hsl(var(--dialog-border))',
        'dialog-close-button': 'hsl(var(--dialog-close-button))',
        'dialog-close-button-foreground': 'hsl(var(--dialog-close-button-foreground))',
      },
      borderRadius: {
        lg: "var(--radius)",
