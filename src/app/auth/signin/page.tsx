      ...
      <Card className="w-full max-w-md space-y-8 bg-white shadow-xl rounded-lg overflow-hidden">
        ...
        <CardContent className="px-8 py-6 space-y-6">
          ...
          <form className="space-y-6" onSubmit={handleEmailSignIn}>
            ...
            <Button
              type="submit"
              className="w-full bg-purple-600 text-white hover:bg-purple-700 py-3 text-base font-medium"
              disabled={loading}
            >
