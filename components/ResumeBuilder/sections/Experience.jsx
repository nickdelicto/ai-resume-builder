...
const Experience = ({ data, updateData, jobContext }) => {
  ...
  const [experiences, setExperiences] = useState(() => {
    ...
    return data.map(exp => ({
      id: exp.id || generateExperienceId(), // Add ID if missing
      title: exp.title || '',
      company: exp.company || '',
  ...
  // Auto-scroll removed - users will manually scroll as needed
  ...
  // Function to handle experience reordering
  const moveExperience = (fromIndex, toIndex) => {
    ...
    // Update autoGeneratedIndices to match new positions
  ...
  // Draggable Experience Tab Component
  const DraggableExperienceTab = ({ exp, index, isActive, onTabClick, onRemove }) => {
